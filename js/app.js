(function () {
  ...
  function getSessionName() {
    try {
      return sessionStorage.getItem(RSVP_KEY) || '';
    } catch (e) {
      return '';
    }
  }
  ...
  function initFirstPage() {
    ...
    form.addEventListener('submit', function (e) {
      ...
      setSession(value);
      var url = 'download.html?name=' + encodeURIComponent(value);
  ...
  function run() {
    var isDownloadPage = document.getElementById('download-card') !== null;
    if (isDownloadPage) {
      initDownloadPage();
    } else {
      initFirstPage();
